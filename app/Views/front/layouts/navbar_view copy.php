  ...
  <div class="container-fluid logotipo">
    ...
    <div class="collapse navbar-collapse" id="navbarsExample09">
      ...
      <li class="nav-item dropdown">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo ($currentPage == 'registrate') ? 'active' : '' ?>" href="<?php echo base_url("registrate") ?>">Registrate</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php echo ($currentPage == 'login') ? 'active' : '' ?>" href="<?php echo base_url("login") ?>">Login</a>
        </li>
