...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 text-body-emphasis mb-3">Editar - Usuario</h1>
        ...
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary" action="<?php base_url('update_user') ?>" method="post" autocomplete="off">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput-Usuario" placeholder="fulanito_kpo123" name="nombre_usuario" value="<?= $user->nombre_usuario?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput-Nombre" placeholder="Fulanito" name="nombre_user" value="<?= $user->nombre_user?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput-Apellido" placeholder="Inserte Apellido" name="apellido_user" value="<?= $user->apellido_user?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingInput-Email" placeholder="name@example.com" name="correo_user" value="<?= $user->correo_user?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="contrasena_user">
                ...
                <div class="form-floating mb-3">
                    <input type="tel" class="form-control" id="floatingInput-Tel" placeholder="Num de tel" name="tel_user" value="<?= $user->tel_user?>" required>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput-Adress" placeholder="Direccion" name="direccion_user" value="<?= $user->direccion_user?>" required>
                ...
                <hr class="my-4">
                <button class="w-100 btn btn-lg bg-custom-btn" type="submit">Editar Usuario</button>
            </form>
        </div>
    </div>
</div>
